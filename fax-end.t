...
-------------------
  ...
  ************************************************************************
  ...
  Info: Set RUCIO_ACCOUNT to jenkins
  ************************************************************************
  *****************************************************************
...
create proxy
------------
  $ voms-proxy-init -voms atlas | tail -3
  Created proxy in /tmp/x509up_u21738.
  
  Your proxy is valid until Thu Jul 24 21:49:09 CDT 2014

  $ fax-is-dataset-covered user.ilijav.HCtest.1
  user.ilijav.HCtest.1     complete replicas: 55\tincomplete: 0
...
--------------------------------
  $ xrdcp $STORAGEPREFIX/atlas/rucio/user/ivukotic:group.test.hc.NTUP_SMWZ.root/tmp/myLocalCopy.root | tail -1
